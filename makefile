...
all:
	$(CC) src/BNMO/*.c src/ADT/Mesin/*.c src/ADT/Array/*.c src/ADT/Queue/*.c src/UserCreated/*.c src/Hangman/*.c src/DinerDash/*.c src/DinerDash/ADT_Local/*.c src/RNG/*.c -o $(TARGET) 
