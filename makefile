...
all:
	$(CC) src/BNMO/*.c src/ADT/Mesin/*.c src/ADT/Array/*.c src/ADT/Queue/*.c src/ADT/Stack/*.c src/ADT/Set/*.c src/ADT/Map/*.c src/ADT/LinkedList/*.c src/RNG/*.c src/UserCreated/*.c src/DinerDash/*.c src/DinerDash/ADT_Local/*.c src/Hangman/*.c src/TowerofHanoi/*.c src/SnakeOnMeteor/*.c -o $(TARGET) 
